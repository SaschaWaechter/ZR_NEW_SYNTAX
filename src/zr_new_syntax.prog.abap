...
SELECTION-SCREEN BEGIN OF BLOCK rel_740 WITH FRAME TITLE TEXT-740.
  "Inline-Deklarationen
  PARAMETERS p_inline AS CHECKBOX.
  "Switch und Cond
...
SELECTION-SCREEN BEGIN OF BLOCK rel_740_8 WITH FRAME TITLE TEXT-748.
  "FOR-Expressions
  PARAMETERS p_for AS CHECKBOX.
SELECTION-SCREEN END OF BLOCK rel_740_8.
